...
function M.groups(theme)
    ...
    return {
        ...
        VertSplit = { bg = (config.options.transparency or config.options.nobackground) and "NONE" or theme.palette.bg, fg = theme.palette.gray }, -- the column separating vertically split windows
        Folded = { bg = (config.options.transparency or config.options.nobackground) and "NONE" or theme.generated.fold, fg = theme.palette.gray }, -- line used for closed folds
        FoldedNC = {
            bg = (config.options.transparency or config.options.nobackground) and "NONE" or theme.generated.color_column,
        ...
        SignColumn = { bg = (config.options.transparency or config.options.nobackground) and "NONE" or theme.palette.bg }, -- column where |signs| are displayed
        SignColumnNC = {
            bg = (config.options.transparency or config.options.nobackground) and "NONE" or theme.generated.color_column,
            fg = theme.palette.gray,
        ...
        LineNr = { bg = (config.options.transparency or config.options.nobackground) and "NONE" or theme.palette.bg, fg = theme.generated.line_number }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
        LineNrNC = {
            bg = (config.options.transparency or config.options.nobackground) and "NONE" or theme.generated.color_column,
            fg = theme.generated.line_number,
        ...
        NonText = { bg = (config.options.transparency or config.options.nobackground) and "NONE" or theme.palette.bg, fg = theme.palette.gray }, -- '@' at the end of the window, characters from 'showbreak' and other characters that do not really exist in the text (e.g., ">" displayed when a double-wide character doesn't fit at the end of the line). See also |hl-EndOfBuffer|.
        Normal = { bg = (config.options.transparency or config.options.nobackground) and "NONE" or theme.palette.bg, fg = theme.palette.fg }, -- normal text
        NormalNC = {
        ...
        Question = { bg = (config.options.transparency or config.options.nobackground) and "NONE" or theme.palette.bg, fg = theme.palette.gray }, -- |hit-enter| prompt and yes/no questions
        ...
        TabLine = { bg = (config.options.transparency or config.options.nobackground) and "NONE" or theme.palette.bg }, -- tab pages line, not active tab page label
        TabLineFill = { bg = (config.options.transparency or config.options.nobackground) and "NONE" or theme.palette.bg, fg = theme.palette.fg }, -- tab pages line, where there are no labels
        ...
        WinBar = { bg = (config.options.transparency or config.options.nobackground) and "NONE" or theme.palette.bg, fg = theme.palette.fg },
        WinBarNC = {
            bg = (config.options.transparency or config.options.nobackground) and "NONE"
                or config.options.highlight_inactive_windows and theme.generated.color_column
                or theme.palette.bg,
        ...
        WinSeparator = { bg = (config.options.transparency or config.options.nobackground) and "NONE" or theme.palette.bg, fg = theme.palette.gray }, -- the column separating windows
